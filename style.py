    ...
    st.sidebar.markdown(
        ...
        <div style="padding: 8px 0 16px; border-bottom: 1px solid #1e1e35; margin-bottom: 12px;">
            <div style="display: flex; align-items: center; gap: 10px;">
                ...
                <div>
                    <div style="font-weight:700; font-size:0.92rem; color:#eaeaf2;">QC Master Pro</div>
                    <div style="font-size:0.65rem; color:#50506a;">LGJA Edition</div>
                </div>
            </div>
        </div>
        """,
